...
class My_FP_ALU(FUDesc):
    opList = [ OpDesc(opClass='FloatAdd', opLat=2), # increased from 2 to 4
               OpDesc(opClass='FloatCmp', opLat=2), # increased from 2 to 4
               OpDesc(opClass='FloatCvt', opLat=2) ] # increased from 2 to 4
    count = 1
